...
Condition as with the LMM. However, this model failed to converge with 
random effects on the interaction, so we had to remove it.
```{r}
...
I'm going to make some figures.
```{r}
